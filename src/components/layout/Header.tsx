      ...
      <div className="flex items-center space-x-3 md:space-x-6">
        <div ref={searchRef} className="relative group block w-8 md:w-72 lg:w-96">
          ...
          {showResults && searchQuery.trim() && (
            <div className="absolute top-14 left-auto right-0 md:left-0 md:right-auto w-64 md:w-full glass border border-border rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
